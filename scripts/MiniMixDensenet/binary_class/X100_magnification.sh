  ...
  do
    ...
    do
      ...
      do
        ...
        do
          experiment_result_location="./experiments/ttemp2_noema_SGD_cos_reduced_params_6666_${magnification}_${seed}_${labeled_images}_${loss_lambda_u}_${dropout}_${weight_decay}_${learning_rate}"
