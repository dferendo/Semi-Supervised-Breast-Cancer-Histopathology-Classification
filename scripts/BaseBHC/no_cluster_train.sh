...
do
  ...
  do
    experiment_result_location="./experiments/base_tune_test_1_${magnification}_${unlabelled_split}"
    ...
    python ../../src/main.py --use_gpu "True" --batch_size 20 --num_epochs 1 --continue_from_epoch -1 --seed 0 \
