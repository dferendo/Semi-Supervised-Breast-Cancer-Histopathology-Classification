  ...
  do
    ...
    do
      ...
      do
        ...
        do
          experiment_result_location="./experiments/noema_SGD_step_300e_${magnification}_${seed}_${labeled_images}_${loss_lambda_u}_${dropout}_${weight_decay}_${learning_rate}"
